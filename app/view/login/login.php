<div class="user-form ajax-resizable-container" id="login-container">
  <div id="title-container">
    <h1>Log In</h1>
  </div>
  <div id="text-container">
    <h3>Choose a login mode with</h3>
  </div>
  <div id="form-fb-container">
    <ul>
      <li><div class="button" onclick="logInFBUser();"><span class="button-icon"><img src="<?php echo IMG;?>FB-f-Logo__white_29.png"/></span><h4>FACEBOOK</h4></div></li>
    </ul>
  </div>
